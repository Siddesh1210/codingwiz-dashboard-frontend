            ...
            <div className="w-100 min-h-screen bg-secondary flex justify-center items-center">
                <div className="md:w-[40%] w-[90%] flex flex-col justify-center text-center items-center">
                    ...
                    <div className="w-[90%] bg-white my-3 p-5 rounded-xl flex flex-col justify-center items-center">
                        ...
                        <p className='text-gray-500 text-md my-3 tracking-wide'>To continue, please enter the 6-digit verification code sent to<br></br>your Email: xyz@gmail.com</p>
                        ...
                        <div className="flex gap-3 my-3">
                            ...
                            <input
                                ...
                                className="w-12 h-12 text-center text-xl font-bold border-2 border-gray-300 rounded-md focus:border-primary focus:outline-none transition-all"
                            />
                            ))}
                        </div>
                        ...
                        <button className='w-[90%] bg-primary py-2 rounded-md text-white text-center cursor-pointer flex items-center justify-center gap-3 my-3 text-md border-primary'>Verify <i className="bi bi-arrow-right"></i></button>
                    </div>
